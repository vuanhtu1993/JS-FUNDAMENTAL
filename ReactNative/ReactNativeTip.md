...
```
#### Method 3:
## React Naative Side Menu
- Link: https://github.com/react-native-community/react-native-side-menu
```javascript
...
- Link : https://kylewbanks.com/blog/fullscreen-background-image-in-react-native
```javascript
import React, { Component } from 'react';
import {
  StyleSheet,
